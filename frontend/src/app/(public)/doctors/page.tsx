...
const DOCTORS = [
  { name: 'Dr. Rajesh Patel', title: 'Senior Physiotherapist & Director', qual: 'BPT, MPT (Orthopedics)', exp: '15+ Years', specialties: ['Spine Care', 'Sports Rehab', 'Orthopedics'], avatar: 'RP' },
  { name: 'Dr. Anita Shah', title: 'Neuro Physiotherapy Specialist', qual: 'BPT, MPT (Neurology)', exp: '12+ Years', specialties: ['Neuro Rehab', 'Stroke Rehab', 'Pediatrics'], avatar: 'AS' },
  { name: 'Dr. Vikram Mehta', title: 'Sports & Orthopedic Physiotherapist', qual: 'BPT, MPT, Cert. Sports Physio', exp: '10+ Years', specialties: ['Sports Rehab', 'Orthopedics', 'Post-Op'], avatar: 'VM' },
  { name: 'Dr. Meena Joshi', title: 'Geriatric & Women\'s Health Specialist', qual: 'BPT, MPT (Geriatrics)', exp: '8+ Years', specialties: ['Elderly Care', 'Women\'s Health'], avatar: 'MJ' },
  { name: 'Dr. Suresh Nair', title: 'Pediatric Physiotherapy Specialist', qual: 'BPT, MPT (Pediatrics)', exp: '9+ Years', specialties: ['Pediatrics', 'Neuro Rehab'], avatar: 'SN' },
  { name: 'Dr. Priya Desai', title: 'Musculoskeletal Physiotherapist', qual: 'BPT, MPT, MIAP', exp: '7+ Years', specialties: ['Orthopedics', 'Spine Care'], avatar: 'PD' },
];
